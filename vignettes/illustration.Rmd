...
The hazard function incorporates both biomarker value and its rate of change:

$$h(t) = h_0(t) \exp(\beta_1 m(t) + \beta_2 |m'(t)|)$$

Here $|m'(t)|$ captures variability—rapid changes in either direction indicate instability and elevated risk.

Consider blood glucose: stable levels suggest controlled diabetes, while rapid fluctuations (high $|m'(t)|$) indicate poor glycemic control and higher complication risk, effectively measuring the temporal variance of the biomarker.

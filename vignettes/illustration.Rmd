---
title: "Biomarker Dynamics via Second-Order ODEs"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Biomarker Dynamics via Second-Order ODEs}
...
> **Note**: This vignette draws inspiration from the [doremi](https://CRAN.R-project.org/package=doremi) package for modeling dynamical systems.

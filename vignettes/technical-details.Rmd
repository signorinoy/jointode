...
$$\frac{\partial m_i(t)}{\partial \boldsymbol{\beta}} = \int_{0}^{t} \frac{\partial\dot{m}_i(s)}{\partial \boldsymbol{\beta}} \,\mathrm{d}s,\quad \frac{\partial\dot{m}_i(t)}{\partial \boldsymbol{\beta}} = \frac{\partial g(\boldsymbol{\beta}^{\top}\mathbf{Z}(t))}{\partial \boldsymbol{\beta}} = \boldsymbol{\theta}^{\top}\mathbf{B}'_g(u) \mathbf{Z}(t)$$

$$\frac{\partial m_i(t)}{\partial \boldsymbol{\theta}} = \int_{0}^{t} \frac{\partial\dot{m}_i(s)}{\partial \boldsymbol{\theta}} \,\mathrm{d}s,\quad \frac{\partial\dot{m}_i(t)}{\partial \boldsymbol{\theta}} = \frac{\partial g(\boldsymbol{\beta}^{\top}\mathbf{Z}(t))}{\partial \boldsymbol{\theta}} = \mathbf{B}_g(u)$$

...
The key computational challenge is obtaining the state sensitivities:
- $\frac{\partial m_i(T_{ij})}{\partial \boldsymbol{\psi}}$ at each observation time $T_{ij}$
- $\frac{\partial \Lambda_i(T_i)}{\partial \boldsymbol{\psi}}$ at the event time $T_i$
